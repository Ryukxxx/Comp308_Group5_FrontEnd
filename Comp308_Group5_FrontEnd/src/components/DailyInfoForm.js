    ...
    return (
        <div className="formContainer">
            <button  className='btn btn-primary'
                ...
                style={{ position: 'absolute', top: '80%', right: '550px', padding: '8px 16px', color:'white', background:'black' }}  // Inline styles for the button
            >
                Send Symptoms
            </button>
            <form onSubmit={handleSubmit}>
                ...
                <button className="button" type="submit" disabled={loading} style={{padding: '8px 16px', background:'black'}}>Submit
                </button>
